...
import { collection, addDoc, getFirestore, getDocs, doc, setDoc } from "firebase/firestore/lite";
...
export default function MyMenu(): JSX.Element {
  ...
  const accessDB = collection(getFirestore(firebaseApp), "saveCats", "카테고리명", "이미지명");
